...
part /boot --fstype=ext3 --fsoptions="defaults,discard" --size=512 --ondisk=${DISK:-sda}
...
#Thick LVM
logvol / --vgname=${vgname:-VolGroup00}  --fstype=ext3 --fsoptions="defaults,discard" --name=lv_root --size=10240
logvol /usr --vgname=${vgname:-VolGroup00}  --fstype=ext3 --fsoptions="defaults,discard" --name=lv_usr --size=10240
logvol /var --vgname=${vgname:-VolGroup00}  --fstype=ext3 --fsoptions="defaults,discard" --name=lv_var --size=10240
logvol /tmp --vgname=${vgname:-VolGroup00}  --fstype=ext3 --fsoptions="defaults,discard" --name=lv_tmp --size=4096
logvol /home --vgname=${vgname:-VolGroup00}  --fstype=ext3 --fsoptions="defaults,discard" --name=lv_home --size=10240
