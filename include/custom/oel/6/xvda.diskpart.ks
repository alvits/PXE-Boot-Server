...
#Thick LVM
logvol / --vgname=${vgname}  --fstype=ext4 --fsoptions="defaults,discard" --name=lv_root --size=1024
logvol /usr --vgname=${vgname}  --fstype=ext4 --fsoptions="defaults,discard" --name=lv_usr --size=5120
logvol /var --vgname=${vgname}  --fstype=ext4 --fsoptions="defaults,discard" --name=lv_var --size=3072
logvol /tmp --vgname=${vgname}  --fstype=ext4 --fsoptions="defaults,discard" --name=lv_tmp --size=4096
logvol /home --vgname=${vgname}  --fstype=ext4 --fsoptions="defaults,discard" --name=lv_home --size=1024
