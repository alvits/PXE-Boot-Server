...
logvol / --vgname=${vgname:-vg00} --thin --poolname ${thinpool:-thinp} --fstype=ext4 --fsoptions="defaults,discard" --name=lv_root --size=10240
logvol /usr --vgname=${vgname:-vg00} --thin --poolname ${thinpool:-thinp} --fstype=ext4 --fsoptions="defaults,discard" --name=lv_usr --size=10240
logvol /var --vgname=${vgname:-vg00} --thin --poolname ${thinpool:-thinp} --fstype=ext4 --fsoptions="defaults,discard" --name=lv_var --size=10240
logvol /tmp --vgname=${vgname:-vg00} --thin --poolname ${thinpool:-thinp} --fstype=ext4 --fsoptions="defaults,discard" --name=lv_tmp --size=4096
logvol /home --vgname=${vgname:-vg00} --thin --poolname ${thinpool:-thinp} --fstype=ext4 --fsoptions="defaults,discard" --name=lv_home --size=10240
